import { _addUser, _getQuestions, _getUsers, _signinUser, _saveQuestionAnswer, _getLastAuthedUserData } from './_DATA.js'
...
export const getLastAuthedUserData = (authedUserId) => _getLastAuthedUserData(authedUserId)
